...
public sealed class ViewCreateMap : MonoBehaviour
{
	...
	*/
    ...
    private static ViewCreateMap instance;
    ...
    public static ViewCreateMap Instance
    {
        get
        {
            if(instance == null)
            {
                instance = new ViewCreateMap();
            }
