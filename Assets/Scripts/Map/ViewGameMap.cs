...
namespace UI
{
    public class ViewGameMap : MonoBehaviour
    {
        ...
        public void updateLogEvent(List<string> messages)
        {
            ...
            {
                updateLogEvent(messageToDisplay);
            }
        }
        ...
        public void drawMap(List<StateData> stateData)
        {
            ...
            {
                StateBattle newState = Instantiate(statePrefab, state.getVector(), Quaternion.identity);
                ...
                BattleStateUI uiState = Instantiate(stateUIPrefab, state.getVector(), Quaternion.identity);
